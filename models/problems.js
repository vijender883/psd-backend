...
const problems = {
  traffic_flow_analysis: {
    ...
    description:
      "You're working as a data scientist for a smart city project. The city has installed sensors along a main road that measure traffic density at different points. The sensors return values representing the 'congestion level' at each point (higher values = more congested).\n\nYour task is to find the longest continuous stretch of road where the traffic flow is 'balanced' - meaning the total congestion on the left half equals the total congestion on the right half.\n\nNote: Only consider subarrays with even length (so they can be split into equal halves).",
    inputFormat:
      "A single line containing space-separated integers representing the traffic_density array.",
    outputFormat:
      "Return the length of the longest balanced stretch. Return 0 if no balanced stretch exists.",
    constraints: [
    ...
    miscellaneous: {
      name: "Hint",
      description:
        "Use two pointers to define the boundaries of subarrays and efficiently calculate the sums of left and right halves. Consider a nested loop approach where you fix one boundary and extend the other.",
    },
    templates: {
    ...
    testCases: [
      ...
      },
      {
        ...
        expectedOutput: "4",
        description:
          "Check if [8,2,6,4] is balanced: left=[8,2]=10, right=[6,4]=10",
      },
    ],
  },
  deletenthfromend: {
    ...
    inputFormat:
      "The first line contains space-separated integers representing the linked list nodes.\nThe second line contains a single integer n representing the position from the end.",
    outputFormat:
      "Return the modified linked list as space-separated integers.",
    constraints: [
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Could you solve this in one pass using the two-pointer technique?",
    },
    templates: {
      javascript: `/**
...
public class Solution {
  ...
  arraychunk: {
    ...
    title: "Array Chunk",
    description:
      "Given an array and a chunk size, divide the array into multiple subarrays where each subarray has a length equal to the chunk size. The last chunk may contain fewer elements if the array length is not evenly divisible by the chunk size.",
    inputFormat:
      "First line: JSON array of numbers\nSecond line: Integer representing chunk size",
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Can you solve this without using any built-in array methods like slice()?",
    },
    templates: {
      java: "N/A",
      python: "N/A",
  ...
  flattenobject: {
    ...
    description:
      'Given a nested JavaScript object, flatten it into a single level object where keys represent the path to each value using dot notation. For example, {a: {b: {c: 1}}} becomes {"a.b.c": 1}.',
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Can you also implement the reverse operation - unflatten a flattened object back to nested structure?",
    },
    templates: {
      java: "N/A",
      python: "N/A",
...
The output should be: [[1,3,6,8], [2,5], [4], [7]]`,
    inputFormat:
      "The input is provided as a series of space-separated integers representing the tree in level-order format. Use -1 to represent null nodes.",
    outputFormat:
      "Return a list of lists where each inner list represents nodes in a diagonal path from left to right.",
    constraints: [
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Can you solve this problem using an iterative approach with a queue instead of recursion?",
    },
    templates: {
  ...
  longestincreasing: {
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Can you solve this problem in O(n log n) time complexity using binary search?",
    },
    templates: {
  ...
  countconsecutive: {
    ...
    description:
      "Given a string `s` consisting of lowercase English letters, return an array of integers representing the count of consecutive occurrences of each character in the order they appear.",
    inputFormat:
      "A single line containing a string of lowercase English letters.",
    outputFormat:
      "Return an array of integers where each integer represents the count of consecutive occurrences of a character.",
    constraints: [
      "1 <= s.length <= 10^5",
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Can you solve this problem in a single pass through the string with O(1) extra space (excluding the output array)?",
    },
    templates: {
  ...
  minimumpathsum: {
    ...
    description:
      'Given a m x n grid filled with non-negative numbers, find a path from top left to bottom right, which minimizes the sum of all numbers along its path.<br><br>Note: You can only move either down or right at any point in time.<br><br><img src="https://assets.leetcode.com/uploads/2020/11/05/minpath.jpg" alt="Grid Example" style="width: 180px; height: auto; display: block; margin: 1.5rem 1rem 2rem 1rem">',
    inputFormat:
      "The first line contains two space-separated integers m and n representing the grid dimensions.\nThe next m lines contain n space-separated integers each representing the grid values.",
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Can you solve this problem with O(1) space complexity by modifying the input grid in-place?",
    },
    templates: {
  ...
  longestcommonprefix: {
    ...
    outputFormat:
      "Output the longest common prefix string. If there is no common prefix, output an empty string.",
    constraints: [
      "1 ≤ strs.length ≤ 200",
      "0 ≤ strs[i].length ≤ 200",
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Can you solve this problem using a divide-and-conquer approach or trie data structure?",
    },
    templates: {
...
Find the element in the array that is closest in value to the target. If there are multiple such elements (i.e., two elements that are equidistant from the target), return the smaller one.`,
    ...
    outputFormat:
      "Return an integer representing the element in the array that is closest to the target. If there are two elements equidistant from the target, return the smaller one.",
    constraints: [
      "1 <= nums.length <= 10^4",
      "-10^4 <= nums[i] <= 10^4",
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Can you solve this problem in O(log n) time complexity using binary search instead of linear search?",
    },
    templates: {
  ...
  permutationinstring: {
    ...
    inputFormat:
      "Two lines containing strings s1 and s2, each consisting of lowercase English letters.",
    outputFormat:
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Can you solve this problem using a sliding window technique with optimized character frequency counting?",
    },
    templates: {
  ...
  fruitintobaskets: {
    ...
    outputFormat:
      "Return an integer representing the maximum number of fruits you can pick.",
    constraints: [
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Can you solve this problem using a sliding window technique to achieve O(n) time complexity?",
    },
    templates: {
  ...
  validanagram: {
    ...
    miscellaneous: {
      name: "Follow-up",
      description:
        "Could you solve it in O(n) time using only O(1) extra space? What if the inputs contain Unicode characters?",
    },
    templates: {
